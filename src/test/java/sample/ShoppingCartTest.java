...
public class ShoppingCartTest {
    ...
    public void calculateDiscount() {
        ...
        assertEquals(2, ShoppingCart.calculateDiscount(ShoppingCart.ItemType.REGULAR, 20));
        assertEquals(0, ShoppingCart.calculateDiscount(ShoppingCart.ItemType.REGULAR, 0));
